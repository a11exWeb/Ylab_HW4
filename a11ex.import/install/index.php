 ...
 */
class a11ex_import extends CModule
{
    /**
     * ID модуля
     * @var string
     */
    public $MODULE_ID = 'a11ex.import';
    ...
    public function __construct()
    {
        ...
        $this->MODULE_NAME = Loc::getMessage('A11EX_IMPORT_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('A11EX_IMPORT_MODULE_DESCRIPTION');
    }
