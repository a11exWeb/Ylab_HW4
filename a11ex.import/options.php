...
$aTabs = [
    [
        "DIV" => "a11ex_import_tab1",
        "TAB" => Loc::getMessage("A11EX.IMPORT.SETTINGS"),
        "ICON" => "settings",
        "TITLE" => Loc::getMessage("A11EX.IMPORT.TITLE"),
    ],
];
...
$arAllOptions = [
    'main' => [
        ["limit_to_import", Loc::getMessage("A11EX.IMPORT.LIMIT_TO_IMPORT"), '', ['text', '']],
